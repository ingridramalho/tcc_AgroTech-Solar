    ...
    <div className="min-h-screen bg-[#F4F9F4] dark:bg-[rgba(108,135,118,0.5)] flex flex-col font-montserrat font-bold">
      <header className="w-full flex justify-between items-center px-16 py-6">
        ...
        <div className="flex items-center">
          <img src="/logo.png" dark:src="/trator2.png" alt="AgroTech Solar" className="h-18" />
      ...
      <section className="px-6 md:px-50 py-4 flex flex-col md:flex-row items-center gap-10 mb-10">
        ...
        <div className="flex-1">
          ...
          <p className="text-lg text-[#6C8776] dark:text-[#EEF4EE] mb-15 max-w-md font-inter font-regular">
        ...
        <div className="flex-1 flex justify-center items-start">
          <img src="/trator.png" dark:src="/trator2.png" alt="Trator" className="h-100 -mb-10" />
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row gap-10 items-center">
          ...
          <div className="flex-1 space-y-6">
            <div>
              ...
              <ul className="list-disc list-inside text-[#738071] dark:text-[#EEF4EE] font-inter font-regular">
                <li>
