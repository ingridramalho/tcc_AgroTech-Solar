...
export function QuemSomos() {
  return (
    <div className="min-h-screen bg-[#F4F9F4]  dark:bg-[rgba(108,135,118,0.5)] flex flex-col font-Montserrat font-bold">
      ...
      <h2 className="text-2xl font-poppins font-bold text-[#6C8776] dark:text-[#EEF4EE] mb-10 mt-10">
      Quem <span className=" font-poppins font-bold text-[#334E3F]"> somos</span >
        </h2>
      ...
      <section className="flex flex-col items-center py-12 mb-30 mt-30">
        <h3 className="text-2xl font-poppins font-semibold text-[#6C8776] dark:text-[#EEF4EE] mb-7">
          Entre em Contato
        </h3>
        <p className="mb-10 text-[#6C8776] dark:text-[#334E3F] font-poppins font-regular">
        ...
        <form className="flex flex-col items-center gap-4 w-full max-w-xl">
          <div className="flex gap-4 w-full">
            <div className="flex flex-col flex-1">
              <label className="font-poppins font-medium text-[#45624E]  dark:text-[#EEF4EE] mb-1">Nome</label>
              <input type="text"className="flex-1 p-3 rounded-lg  border-gray-300 dark:text-[#6D8777] bg-[rgba(108,135,118,0.5)] focus:outline-none focus:ring-2 focus:ring-green-300"/>
            </div>

            <div className="flex flex-col flex-1">
              <label className="font-poppins font-medium text-gray-600  dark:text-[#EEF4EE] mb-1">Email</label>
              <input type="email"className="flex-1 p-3 rounded-lg border-gray-300 dark:text-[#6D8777] bg-[rgba(108,135,118,0.5)] focus:outline-none focus:ring-2 focus:ring-green-300"/>
            </div>
          </div>

          <div className="flex flex-col w-full">
            <label className="font-poppins font-medium text-gray-600  dark:text-[#EEF4EE] mb-1">Assunto</label>
            <textarea
              className="w-full p-3 h-20 rounded-lg border-gray-300 dark:text-[#6D8777] bg-[rgba(108,135,118,0.5)] focus:outline-none focus:ring-2 focus:ring-green-300 resize-none"></textarea>
          </div>


          <button
            type="submit"
            className="bg-[rgba(108,135,118,0.5)] hover text-[#394931]  dark:text-[#EEF4EE] px-8 py-2 rounded-lg font-poppins font-regular transition">
            Enviar
          </button>
        </form>
